...
final class PHPCache extends CacheItemPool {
    ...
    public function __construct(
        ...
        $drivers[] = new Drivers\OPCacheDriver($rootpath, $prefix); // in 2nd/third position as it is the less faster (it serves to warm APCu, as it can flush data before expired)
